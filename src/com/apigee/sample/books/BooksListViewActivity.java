...
public class BooksListViewActivity extends Activity {
	...
	private static final String ORGNAME = "fpinab"; // <-- Put your username here!!!
    ...
    protected void onCreate(Bundle savedInstanceState) {
    	...
    	System.out.println("antes a if");
    	if( bookApp.getApigeeClient() == null ) {
    		//System.out.print("entré a if");
	...
	public void apigeeInitializationError() {
		...
		CharSequence text = "Apigee client is not initialized. HOLI";
